...
def project_onto_PC(X, pcs, n_components, feature_means):
    ...
    Args:
        X - (n, d) NumPy array of n datapoints each with d features
        pcs - (d, d) NumPy array where each column is a principal component
        n_components - number of principal components to project onto
        feature_means - (d, ) NumPy array of mean values for each feature
    ...
    # Project the centered dataset onto the first n_components principal components
